...
public class AttrsBean {
    ...
    private List<String> multiDatesStrList;//多选时默认选中的日期集合
    ...
    private int dayBg_1 = R.drawable.day_bg_1b;//选中的背景绿
    private int dayBg_2 = R.drawable.day_bg_2b;//选中的背景红
    private int dayBg_3 = R.drawable.day_bg_3b;//选中的背景黄
    ...
    public void setMultiDatesStrList(List<String> multiDatesStrList) {
        this.multiDatesStrList = multiDatesStrList;
    }

    public List<String> getMultiDatesStrList() {
        return multiDatesStrList;
    }
    ...
    public int getDayBg_1() {
        return dayBg_1;
    }

    public int getDayBg_2() {
        return dayBg_2;
    }

    public int getDayBg_3() {
        return dayBg_3;
    }
