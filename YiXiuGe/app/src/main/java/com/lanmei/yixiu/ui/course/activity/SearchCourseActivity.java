package com.lanmei.yixiu.ui.course.activity;
...
//        controller.loadFirstPage();
    ...
    private void loadSearchCourse(String keyword) {
        ...
        controller.loadFirstPage();
//        api.addParams("p", 1);
//        HttpClient.newInstance(this).loadingRequest(api, new BeanRequest.SuccessListener<NoPageListBean<CourseClassifyListBean>>() {
//            @Override
