...
public class MainActivity extends BaseActivity {
	...
	protected static final String TAG = "MainActivityHX";
	...
	private MyMultiDeviceListener multiDeviceListener;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		multiDeviceListener = new MyMultiDeviceListener();
...
//				Toast.makeText(MainActivity.this, "All permissions have been granted", Toast.LENGTH_SHORT).show();
	...
	protected void onDestroy() {
		...
		EMClient.getInstance().removeMultiDeviceListener(multiDeviceListener);//防止內存泄漏
		EMClient.getInstance().contactManager().removeContactListener(contactListener);//防止內存泄漏
		try {
...
//		}
	...
	protected void onNewIntent(Intent intent) {
		...
		L.d(TAG,"MainActivity.onNewIntent");
	}
