...
public class GroupDetailsActivity extends BaseActivity implements OnClickListener {
    ...
    private List<String> memberList = Collections.synchronizedList(new ArrayList<String>());//群成员列表
    private List<String> muteList = Collections.synchronizedList(new ArrayList<String>());//禁言成员列表
    private List<String> blackList = Collections.synchronizedList(new ArrayList<String>());//黑名单成员列表
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        L.d("UserBeanEvent", "updateGroup = 保证每次进详情看到的都是最新的group");
        updateGroup();
...
//                    L.d("UserBeanEvent", "s = " + memberList.size());
                }
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                try {
                                    ...
                                    L.d("UserBeanEvent", "updateGroup = 0000000");
                                    updateGroup();
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            ...
                            L.d("UserBeanEvent", "j = updateGroup");
                            refreshMembersAdapter();
...
//							refreshUIVisibility();
    ...
    private class GroupChangeListener extends EaseGroupListener {
        ...
        public void onInvitationAccepted(String groupId, String inviter, String reason) {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    L.d("UserBeanEvent", "j = onInvitationAccepted");
                    refreshMembersAdapter();
                }
            });
        }
        ...
        public void onMuteListAdded(String groupId, final List<String> mutes, final long muteExpire) {
            L.d("UserBeanEvent", "updateGroup = onMuteListAdded");
            updateGroup();
        }
        ...
        public void onOwnerChanged(String groupId, String newOwner, String oldOwner) {
            ...
            L.d("UserBeanEvent", "updateGroup = onOwnerChanged");
            updateGroup();
        }
...
//            L.d("UserBeanEvent", "updateGroup = onMemberJoined");
//            updateGroup();
        }
...
//            L.d("UserBeanEvent", "updateGroup = onMemberExited");
//            updateGroup();
        }
